...
#     documentation = generate_function_doc(
#         assistant, user, file_name, file_content, called_functions)

#     # Write the documentation to a file at /docs_output/docs.md (add timestamp to the filename)
#     timestamp = datetime.datetime.now().strftime('%Y-%m-%d-%H-%M-%S')
#     output_file = os.path.join("docs_output", f"docs_{
#                                file_name}_{timestamp}.md")
